...
import { useAddNewMovieCommentMutation } from "./movieCommentsApiSlice"
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faSave } from "@fortawesome/free-solid-svg-icons"

const NewMovieCommentForm = ({ users }) => {
    ...
    const onSaveNoteClicked = async (e) => {
        e.preventDefault()
        if (canSave) {
            await addNewMovieComment({ user: userId, title, text, movieId })
        }
    }
...
export default NewMovieCommentForm